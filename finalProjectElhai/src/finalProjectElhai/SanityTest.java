...
class SanityTest {
	...
	//SCREEN-1
		...
		{
			System.out.println("SNITY TEST FAILED - SCREEN 1");
		}
		Thread.sleep(1000);
	...
	//SCREEN-2
		...
		{
			System.out.println("SNITY TEST FAILED - SCREEN 2");
		}
		Thread.sleep(1000);
	...
	//SCREEN-3
		...
		{
			System.out.println("SNITY TEST FAILED - SCREEN 3");
		}
		Thread.sleep(1000);
	...
	//SCREEN-4
		...
		{
			System.out.println("SNITY TEST FAILED - SCREEN 4");
		}
		Thread.sleep(1000);
	...
	//SCREEN-5
		...
		{
			System.out.println("SNITY TEST FAILED - SCREEN 5");
		}
		Thread.sleep(1000);
	...
	//SCREEN-6
		...
		{
			System.out.println("SNITY TEST FAILED - SCREEN 6");
		}
		Thread.sleep(1000);
	...
	//SCREEN-7
		...
		{
			System.out.println("SNITY TEST FAILED - SCREEN 7");
		}
		Thread.sleep(1000);
	...
	//SCREEN-8
		...
		{
			System.out.println("SNITY TEST FAILED - SCREEN 8");
		}
		Thread.sleep(1000);
	...
	//SCREEN-9
		...
		{
			System.out.println("SNITY TEST FAILED - SCREEN 9");
		}
		Thread.sleep(1000);
	...
	//SCREEN-10
		...
		{
			System.out.println("SNITY TEST FAILED - SCREEN 10");
		}
		Thread.sleep(1000);
	...
	//SCREEN-11
		...
		{
			System.out.println("SNITY TEST FAILED - SCREEN 11");
		}
		Thread.sleep(1000);
	...
	//SCREEN-12
		...
		WebElement quitBtn = driver.findElement(By.xpath("//*[@id=\"markpage\"]/center/button[2]"));
		quitBtn.click();
